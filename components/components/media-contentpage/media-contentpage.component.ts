import { Component, OnInit, OnDestroy, OnChanges, Input, EventEmitter, Output, Inject } from '@angular/core';
import { ActivatedRoute, Router, NavigationStart } from '@angular/router';
import { ConfigService, NavigationHelperService, UtilService, ToasterService, ResourceService,PublicPlayerService } from './contentpageinterfaces';
import { Subject } from 'rxjs';
import { takeUntil, filter } from 'rxjs/operators';
import * as _ from 'lodash-es';
import { IImpressionEventInput, TelemetryService } from '@sunbird/telemetry';
import { LayoutService } from '@sunbird/shared';
import { contentpageService } from 'src/app/common.service';
@Component({
  selector: 'app-media-contentpage',
  templateUrl: './media-contentpage.component.html',
  styleUrls: ['./media-contentpage.component.scss']
})
export class MediaContentpageComponent implements OnInit, OnDestroy, OnChanges {
  ...
  constructor(@Inject('ContentpageService') public configService:contentpageService, private activatedRoute: ActivatedRoute,
