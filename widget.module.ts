...
import { MediaChapterlistComponent,MediaPlayerComponent,MediaContentpageComponent,ContentMediaComponent, MediaWidgetComponent} from './components';
...
@NgModule({
  ...
  exports: [
    MediaContentpageComponent,
    MediaChapterlistComponent, MediaWidgetComponent
  ]
})
